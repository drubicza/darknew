import os, sys
print '\x1b[1;32mMasukan ID: Apa Ya?? dan Password: Chat Wa Aja untuk Login'
print '\x1b[1;32mSilahkan Login '
import os, sys

def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=+6282288231535&text=Assalamualaikum')
...
import getpass
sandi = raw_input('[*]T:')
if sandi == 'x00notfree' and user == 'x00safarkeren':
